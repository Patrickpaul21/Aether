...
export const ADDONS: AddOn[] = [
  ...
  },
  {
    id: '1',
    name: 'Navidrome',
    description: 'Access your Navidrome server',
    icon: 'navidrome',
    isInstalled: true,
    isEnabled: true,
    type: 'source',
  ...
  },
  {
    id: '2',
    name: 'Jellyfin',
    description: 'Stream from your Jellyfin server',
    icon: 'jellyfin',
    isInstalled: false,
    isEnabled: false,
    type: 'source',
  ...
  },
  {
    id: 'youtube',
    name: 'YouTube Music',
    description: 'Stream any song via YouTube. No account required.',
    icon: 'youtube',
    isInstalled: false,
    isEnabled: false,
    type: 'source',
  ...
  },
  {
    id: '4',
    name: 'Radio Browser',
    description: 'Explore thousands of radio stations',
    icon: 'radio',
    isInstalled: false,
    isEnabled: false,
    type: 'source',
  ...
  },
  {
    ...
    description: 'Live concert recordings — search any artist name.',
    icon: 'archive',
    isInstalled: false,
    isEnabled: false,
    type: 'source',
  ...
  },
  {
    id: 'spotify',
    name: 'Spotify',
    description: 'Coming soon — playlist import via OAuth. Deploy to HTTPS to enable.',
    icon: 'spotify',
    isInstalled: false,
    isEnabled: false,
    type: 'source',
  ...
  },
  {
    id: 'jiosaavn',
    name: 'JioSaavn',
    description: 'Stream millions of songs — Bollywood, international & more. No account required.',
    icon: 'jiosaavn',
    isInstalled: false,
    isEnabled: false,
    type: 'source',
  ...
  // Tool Add-ons
  {
    id: '6',
    name: 'Last.fm',
    description: 'Scrobble and discover with Last.fm',
    icon: 'lastfm',
    isInstalled: false,
    isEnabled: false,
    type: 'tool',
  ...
  {
    id: 'theme-oled',
    name: 'OLED Black Theme',
    description: 'Ultra-dark pure black UI theme for OLED displays',
    icon: 'palette',
    isInstalled: true,
    isEnabled: true,
    type: 'theme',
  ...
  },
  {
    ...
    description: 'Galactic dark purple theme with stellar accents',
    icon: 'palette',
    isInstalled: true,
    isEnabled: true,
    type: 'theme',
  ...
  },
  {
    id: 'theme-obsidian',
    name: 'Obsidian Theme',
    description: 'Volcanic glass sleek gray theme layout',
    icon: 'palette',
    isInstalled: true,
    isEnabled: true,
    type: 'theme',
